...
func CreateProduct(c *fiber.Ctx) error {
	...
	db.Find(&products)
	return c.JSON(fiber.Map{"status": "success", "message": "Created product", "data": products})
}
...
func DeleteProduct(c *fiber.Ctx) error {
	...
	if err != nil {
		return c.Status(fiber.StatusBadRequest).JSON(fiber.Map{"status": "error", "message": "Couldn't delete product", "data": err})
	}
	db.Find(&products)
	return c.JSON(fiber.Map{"status": "success", "message": "Product successfully deleted", "data": products})
}
